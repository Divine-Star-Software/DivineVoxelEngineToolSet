...
import { form, formButton, formText, formTitle, input, } from "../../../../elements/Forms/Inputs.js";
...
export const LightToolScreen = () => {
    return SubScreen("light-data", false, form([
        ...
        ]),
        {
            ...
            cascade: {
                origin: lightEncodeCascadeProps,
                receiver(elm, cascadeProps) {
                    elm.style.cssText = `background-color:rgb(${(lightFormData.r / 15) * 255},${(lightFormData.g / 15) * 255},${(lightFormData.b / 15) * 255});`;
                },
            },
        },
