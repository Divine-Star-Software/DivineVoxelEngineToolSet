...
import { input, fileInput, dataOutput, formButton, formTitle, formOptionSelect, form, } from "../../../../elements/Forms/Inputs.js";
...
export const TextureToModelScreen = () => {
    return SubScreen("ttm-0", true, form([
        ...
        formButton("Generate", async () => {
            ...
            const result = await TextureProcessor.processTexture(inputBind.id, inputBind.file, formStates.mode);
            if (result) {
