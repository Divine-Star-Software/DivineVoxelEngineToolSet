...
import { dataOutput, form, formButton, formTitle, input, } from "../../../../elements/Forms/Inputs.js";
...
const getVoxelDataText = (voxelData, voxelState) => {
...
export const VoxelDataToolScreen = () => {
    return SubScreen("raw-voxel-data", true, form([
        formTitle("Raw Voxel Data Tool"),
        input("number", "Voxel Data:", "number", voxelFormData, "voxelData"),
        input("number", "Voxel State Data:", "number", voxelFormData, "voxelStateData"),
        formButton("Decode", () => {
